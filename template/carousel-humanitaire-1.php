    ...
    <div id="myCarousel" class="carousel slide keep-style-border-jaune-dmy" data-ride="carousel " style="overflow: hidden;">
        ...
        <div class="carousel-inner" >
            <div class="item active">
                <img src="./img/Humanitaire/1.jpg" alt="ahava torah" style="width:100%;">
            </div>
            <div class="item">
                <img src="./img/Humanitaire/2.jpg" alt="torah-connection" style="width:100%;">
            </div>
            <div class="item">
                <img src="./img/Humanitaire/3.png" alt="Radio shalom" style="width:100%;">
            </div>
        </div>
